      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="relative mx-auto grid min-h-[600px] max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 lg:min-h-[720px] lg:grid-cols-[1.05fr_1.25fr] lg:py-24 lg:px-8">
          <div className="animate-fade-up">
            ...
            <h1 className="text-4xl leading-[1.02] sm:text-5xl lg:text-6xl xl:text-7xl">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mb-10 flex flex-wrap items-end justify-between gap-4">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-2 text-3xl sm:text-4xl lg:text-5xl">Drei Klassen, transparente Preise.</h2>
        ...
        <div className="relative overflow-hidden rounded-3xl border bg-white">
          ...
          <div className="relative grid gap-10 p-8 sm:p-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="mt-2 text-3xl sm:text-4xl">Pflichtkurs für deinen Führerschein.</h2>
              <p className="mt-4 text-muted-foreground">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 flex flex-wrap items-end justify-between gap-4">
              <div className="max-w-2xl">
                ...
                <h2 className="mt-2 text-3xl sm:text-4xl lg:text-5xl">Lerne deine Fahrlehrer kennen.</h2>
                <p className="mt-4 text-muted-foreground">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-5 lg:items-center">
          <div className="lg:col-span-3">
            ...
            <h2 className="mt-2 text-3xl sm:text-4xl">Eine Fahrschule, die zuhört.</h2>
            <p className="mt-4 text-muted-foreground">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 text-3xl sm:text-4xl">Schnelle Antworten.</h2>
            </div>
      ...
      <section className="py-20">
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <h2 className="mt-2 text-3xl sm:text-4xl">Von der Anmeldung bis zur Prüfung.</h2>
      ...
      <section id="standorte" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mb-10 flex flex-wrap items-end justify-between gap-4">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-2 text-3xl sm:text-4xl lg:text-5xl">Zwei Filialen in Bochum.</h2>
            <p className="mt-4 text-muted-foreground">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-[#0a0a0a] p-10 text-white sm:p-16">
          ...
          <div className="relative max-w-xl">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl">Starte deinen Führerschein noch heute.</h2>
